...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
		...
		<div class="container">
			...
			<h2><a href="<%=basePath%>shop">Click here to Continue shopping</a></h2>
					...
					<c:set var="cal" value="${cal+(c.quantity*c.product.price)}"/><!--cal culate Grand Total-->
					</c:forEach>
					<!--loop_end-->
						</c:otherwise>
						</c:choose>
		...
		<div class="container">
			...
			<div class="col-sm-6"></div>
					...
					<div class="total_area">
						<ul>
							<li>Cart Sub Total <span><c:out value="${cal}"/><!-- print sub total--></span></li>
							<!--<li>Eco Tax <span>$2</span></li>-->
							<li>Shipping Cost <span>Free</span></li>
							<li>Total <span><c:out value="${cal}"/><!-- print total--></span></li>
						</ul>
