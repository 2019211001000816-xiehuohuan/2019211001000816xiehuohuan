...
<form method="post" action="<%=request.getContextPath()+"/CalServlet"%>" id="myForm">
        <table>
                <tr>
                        <td>First Val:</td> <td><input type="text" name="firstVal" id="firstVal" value="<%=firstVal%>"></td>
                        <td>Enter a Name:</td> <td><input type="text" name="name" id="name" value="<%=name%>"></td>
                </tr>
                <tr>
                        <td>Second Val:</td> <td><input type="text" name="secondVal" id="secondVal" value="<%=secondVal%>"></td>
                        <td>Length:</td> <td><input type="text" name="length" value="<%=length%>"></td>
                </tr>
                <tr>
                        <td>Result:</td> <td><input type="text" name="result" value="<%=result%>"></td>
                </tr>
        </table>
        <p><input type="button" value="add" onclick="calculationForm(1)"> <input type="button" value="subtract" onclick="calculationForm(2)">
                <input type="button" value="multiply" onclick="calculationForm(3)"> <input type="button" value="divide" onclick="calculationForm(4)">
                <input type="button" value="computeLength" onclick="calculationForm(5)"> <input type="button" value="Reset" onclick="formReset()"></p>
