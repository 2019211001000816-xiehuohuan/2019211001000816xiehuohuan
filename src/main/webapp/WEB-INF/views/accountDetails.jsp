		...
		<div class="container">
				...
				<div class="total_area">
					...
					%>
						<ul>
							...
							<li>Password :<span><%=u.getPassward()%></span></li>
							<li>Email :<span><%=u.getEmail()%></span></li>
							<li>Gender :<span><%=u.getGenter()%></span></li>
			...
			<h1>No Order Found.</h1>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td class="cart_total">
						<%
							com.xiehuohuan.model.Order o=(com.xiehuohuan.model.Order)pageContext.findAttribute("o");
							int n=o.getPaymentId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							String paymentType=com.xiehuohuan.model.Payment.findByPaymentId(con,n);
							 %>
